...
@WebServlet("/TrangChuNoLoginServlet")
public class TrangChuNoLoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(b != 0) {
			...
			request.getRequestDispatcher("/views/TrangChuNoLogin.jsp").forward(request, response);
		}
	}
