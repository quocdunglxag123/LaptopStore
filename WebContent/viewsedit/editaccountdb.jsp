...
<!-- header -->
	...
	<div class="container-viewcontent">
		<div class="row-main">
				...
				<h1 style="margin-top: 2px;">Edit Account</h1>
				...
				<tr>
						<td class="td-main">
							<form action="EditAccountDB" method="post">
								...
								<br /> 
								<input type="hidden" name="id_Account" value="<c:out value='${account.id_Account}' />" /> 
								
								<label for="userName">User Name</label><br />
								<input type="text" id="userName" name="userName" value="${account.userName}" maxlength="200"/><br />

								<label for="passWord">Pass Word</label><br />
								<input type="text" id="passWord" name="passWord" value="${account.passWord}" maxlength="200"/><br />
								...
								<a href="AccountDB">Return List Account</a>
							</form>
						</td>
				</tr>
			</table>
