...
<body>
	...
	<div class="container-viewcontent">
		<div class="row-main">
				...
				<h1 style="margin-top: 2px;">Edit Khách Hàng</h1>

			<hr />
			<table class="table-main">
				<tr>
						<td class="td-main">
							<form action="EditKhachHangDB" method="post">
								<p style="margin: 0; padding: 0; color: green; font-size: x-large">${message}</p>
								
								<br /> 
								<input type="hidden" name="maKH" value="<c:out value='${kh.maKH}' />" /> 
								
								<label for="hoTen">Họ Và Tên:</label><br />
								<input type="text" id="hoTen" name="hoTen" value="${kh.hoTen}" maxlength="200"/><br />

								<label for="ngaySinh">Ngày Sinh:</label><br />
								<input type="date" id="ngaySinh" name="ngaySinh" value="${kh.ngaySinh}" maxlength="200"/><br />
								
								<label for="SDT">Số Điện Thoại:</label><br />
								<input type="text" id="SDT" name="SDT" value="${kh.SDT}" maxlength="200"/><br />
								
								<label for="gmail">Gmail:</label><br />
								<input type="text" id="gmail" name="gmail" value="${kh.gmail}" maxlength="200"/><br />
								
								
								<input type="hidden" id="id_Account" name="id_Account" value="${kh.id_Account}" maxlength="200"/><br />
								...
								<a href="KhachHangDB">Return List KhachHang</a>
							</form>
						</td>
				</tr>
			</table>
