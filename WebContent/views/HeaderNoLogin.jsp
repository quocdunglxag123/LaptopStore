		...
		<div class="container">
			<div class="content_header">
				...
				<div class="menu_header">
					<nav>
						<ul class="nav_link">
							<li><a href="/WebsiteLapTop/TrangChuNoLoginServlet">Trang Chủ</a></li>
							<li><a href="/WebsiteLapTop/SanPhamNoLoginServlet">Sản Phẩm</a></li>
							<li><a href="/WebsiteLapTop/LoginServlet">Đăng Nhập</a></li>
							<li><a href="/WebsiteLapTop/RegisterServlet">Đăng Ký</a></li>
						</ul>
					</nav>
				</div>
